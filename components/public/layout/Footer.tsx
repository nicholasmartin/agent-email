    ...
    <footer className="bg-gray-900 border-t border-gray-800">
      <div className="container mx-auto px-4 py-8 md:py-12 overflow-hidden">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8">
          <div className="col-span-2 sm:col-span-3 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              AI-powered personalized welcome emails that turn signups into engaged customers.
            </p>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-200 uppercase mb-4">Product</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-200 uppercase mb-4">Company</h3>
            <ul className="space-y-3">
        ...
        <div className="mt-8 md:mt-12 pt-6 md:pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-xs sm:text-sm">&copy; {new Date().getFullYear()} Agent Email. All rights reserved.</p>
          <div className="flex flex-wrap justify-center space-x-4 md:space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-gray-500 hover:text-indigo-400 text-xs sm:text-sm">Privacy Policy</a>
            <a href="#" className="text-gray-500 hover:text-indigo-400 text-xs sm:text-sm">Terms of Service</a>
            <a href="#" className="text-gray-500 hover:text-indigo-400 text-xs sm:text-sm">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
